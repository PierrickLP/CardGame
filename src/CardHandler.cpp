...
CardManager* CardHandler::m_manager;
void CardHandler::Init(CardManager* cardManager)
{
...
unsigned int CardHandler::getMapPosition() const
{
...
unsigned int CardHandler::lastPosition() const
{
